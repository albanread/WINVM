...
//! Rasm â€” the native x86-64 encoder that replaces LLVM-MC.
//!
...
//!
//! Layering: [`parse`] (text â†’ [`Line`]) â†’ [`encode`] (one instruction â†’ bytes)
//! â†’ this module's two-pass driver (assign offsets, resolve internal labels +
//! branch relaxation, emit relocs) â†’ `EncodedModule`.
...
/// The native from-scratch x86-64 [`Encoder`](crate::vendor::wfasm::backend::Encoder) â€” the
